...
## Acceptance Criteria
- [ ] Goal subdocument schema defined in `backend/src/models/schemas/goal.schema.js`.
- [ ] `description` field is defined as String and Required.
- [ ] `conditionScript` field is defined as String and Required.
